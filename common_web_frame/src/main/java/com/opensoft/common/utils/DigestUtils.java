...
public class DigestUtils {
     ...
     *          异常
     */
    public static String desEncrypt(String key, String source) throws InvalidKeyException, InvalidKeySpecException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException {
     ...
     *          异常
     */
    public static byte[] desDecrypt(String key, String target) throws InvalidKeyException, InvalidKeySpecException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException {
        Key secretKey = generateKey(key, ALGORITHM_DES);
        Cipher cipher = Cipher.getInstance(ALGORITHM_DES);
     ...
     *          异常
     */
    private static Key generateKey(String key, String algorithm) throws InvalidKeyException, NoSuchAlgorithmException, InvalidKeySpecException {
